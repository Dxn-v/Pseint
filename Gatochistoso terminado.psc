		...
		si n > 0 y n < 10 Entonces
			si jugador = 1 Entonces
				si vector(n) == " " Entonces
					...
					// Verificación para el jugador 1
			...
			SiNo
				si vector(n) == " " Entonces
					...
					// Verificación para el jugador 2
					si vector(1) == "0" y vector(2) == "0" y vector(3) == "0" Entonces
						Escribir "El jugador 2 ha ganado";
						x = 9;
					FinSi
					si vector(4) == "0" y vector(5) == "0" y vector(6) == "0" Entonces
						Escribir "El jugador 2 ha ganado";
						x = 9;
					FinSi
					si vector(7) == "0" y vector(8) == "0" y vector(9) == "0" Entonces
						Escribir "El jugador 2 ha ganado";
						x = 9;
					FinSi
					si vector(1) == "0" y vector(4) == "0" y vector(7) == "0" Entonces
						Escribir "El jugador 2 ha ganado";
						x = 9;
					FinSi
					si vector(2) == "0" y vector(5) == "0" y vector(8) == "0" Entonces
						Escribir "El jugador 2 ha ganado";
						x = 9;
					FinSi
					si vector(3) == "0" y vector(6) == "0" y vector(9) == "0" Entonces
						Escribir "El jugador 2 ha ganado";
						x = 9;
					FinSi
